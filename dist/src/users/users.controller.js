...
let UsersController = class UsersController {
    ...
    async findOne(id) {
        ...
        if (!user) {
            throw new common_1.NotFoundException('The user you are trying to find does not exists');
        }
        return user;
    }
    async delete(id) {
        ...
        if (!deletedUser) {
            throw new common_1.NotFoundException('The user you are trying to delete does not exists');
        }
    ...
    async update(id, body) {
        ...
        if (!updatedUser) {
            throw new common_1.NotFoundException('The user you are trying to update does not exists');
        }
